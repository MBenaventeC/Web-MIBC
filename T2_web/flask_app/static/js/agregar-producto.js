...
const comunaSegunRegion = () => {
    ...
    if (region == "15") {
        ...
        opciones = [
            {texto: "Escoja una comuna", valor: "0"},
...
const validarComuna = (region, comuna) => {
    if (region == "15") {
        return comuna != "0" && (comuna.startsWith("101") || comuna.startsWith("102"))
    }
    if (region == "8") {
        return comuna != "0" && (comuna.startsWith(region+"02") || comuna.startsWith(region+"03") || comuna.startsWith(region+"04"));
    }
    if (region == "10") {
        return comuna != "0" && (comuna.startsWith(region+"02") || comuna.startsWith(region+"03") || comuna.startsWith(region+"04") || comuna.startsWith(region+"05"));
    }
    if (region == "14") {
        return comuna != "0" && comuna.startsWith("1001");
    }
    if (region == "16") {
        return comuna != "0" && comuna.startsWith("801");
    }
    if (region != "15" && comuna != "8" && comuna != "10" && comuna != "14" && comuna != "16") {
        return comuna != "0" && comuna.startsWith(region);
    }
};
